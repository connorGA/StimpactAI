...
class AutonomousRepairRunRecord(BaseModel):
    ...
    incident_title: str | None = Field(default=None, max_length=512)
    incident_fingerprint: str | None = Field(default=None, max_length=128)
    service_name: str | None = Field(default=None, max_length=200)
    environment: str | None = Field(default=None, max_length=64)
    latest_telemetry_id: str | None = Field(default=None, max_length=128)
    latest_telemetry_commit_sha: str | None = Field(default=None, max_length=256)
    latest_telemetry_error_message: str | None = Field(default=None, max_length=2_000)
    runtime_kind: str | None = Field(default=None, max_length=64)
    provider_repository_owner: str | None = Field(default=None, max_length=256)
    provider_repository_name: str | None = Field(default=None, max_length=256)
    install_command: str | None = Field(default=None, max_length=8_000)
